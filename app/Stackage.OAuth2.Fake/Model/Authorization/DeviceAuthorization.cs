...
public record DeviceAuthorization(string DeviceCode, string UserCode, string ClientId, Scope Scope, string[]? Audiences) : IAuthorizationWithCode, IAuthorizationWithAudiences
{
