...
public class create_token_with_negative_expiry_seconds
{
   ...
   [Test]
   public async Task response_content_should_contain_access_token_with_past_valid_to()
   {
      var tokenResponse = await _httpResponse!.ParseAsync<TokenResponse>();
   ...
   [Test]
   public async Task response_content_should_contain_access_token_with_past_valid_from()
   {
      var tokenResponse = await _httpResponse!.ParseAsync<TokenResponse>();
